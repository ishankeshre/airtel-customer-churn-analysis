...
* Examine the relationship between customer behaviour and churn
* Analyze churn across different service and demographic attributes
...
* Overall churn rate
* Average account length for churned vs. non-churned customers
* Relationship between account tenure and churn

### Medium Analysis

* Churn by area code
* Churn based on customer service calls
* Churn by customer usage patterns
* Analysis of different customer segments and service attributes

### Advanced Analysis

* Interaction effects between customer attributes
...
│
├── README.md
├── Airtel_Customer_Churn_Analysis.xlsx
└── screenshots/
    └── dashboard.png
```
